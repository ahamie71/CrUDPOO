...
<body>
            ...
            <form action="index.php?action=createProduct" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="form-outline mb-4">
                        <textarea class="form-control" id="form4Example3" rows="4" name="description"
    ...
    <?php foreach ($languages as $language) { ?>
        <option value="<?php echo $language->getIdLang(); ?>"><?php echo htmlspecialchars($language->getLanguageName()); ?></option>
    <?php } ?>
</select>

                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit"
                            name="register">Ajouter
                        </button></div>
